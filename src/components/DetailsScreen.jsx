    ...
    <div className="modal">
      ...
      <div className="content">
        <form className="crud">
          ...
          <input type="text" id="start-lat" name="startLat" value={String(movement.startLat) || ""} onChange={handleChange} />
          <label htmlFor="start-long">Starting Longitude: </label>
          <input type="text" id="start-long" name="startLong" value={String(movement.startLong) || ""} onChange={handleChange} />
          ...
          <input type="text" id="end-lat" name="endLat" value={String(movement.endLat) || ""} onChange={handleChange}/>
          <label htmlFor="end-long">Ending Longitude: </label>
          <input type="text" id="end-long" name="endLong" value={String(movement.endLong) || ""} onChange={handleChange} />
